...
navdconv: ndcobj libobj comobj compat wmmobj
	$(CC) $(ND_INCLUDE) $(NDCCPPFLAGS) $(CPPFLAGS) $(NDC_VERSION) $(CFLAGS) $(LDFLAGS) $(TARGETARCH) -o $(NDCONV_EXE) $(NDC_OBJECTS) $(LIB_OBJECTS) $(COM_OBJECTS) $(CPT_OBJECTS) $(WMM_OBJECTS) $(LIBACU_LIB) $(LDLIBS)
...
wmmobj: $(WMM_SOURCES) $(WMM_HEADERS)
	$(CC) $(ND_INCLUDE) $(LIBACU_INC) $(NDCCPPFLAGS) $(CPPFLAGS) $(CFLAGS) $(TARGETARCH) -c $(WMM_SOURCES)
