...
static int print_examples(void)
{
    ...
    fprintf(stderr,
            ...
            "                                                                   \n"
            " \"civa\" (output only):                                           \n"
            "     0  LSGG              1  N 46 14.3' E 006 06.6'                \n"
            "     1  MOLUS             2  N 46 26.6' E 006 40.8'                \n"
            "     2  SOSAL             3  N 46 33.5' E 006 53.1'                \n"
            "     3  TELNO             4  N 46 46.3' E 007 16.2'                \n"
            "     4  KORED             5  N 46 51.0' E 007 24.9'                \n"
            "     5  KONOL             6  N 46 59.7' E 007 40.8'                \n"
            "     6  BERSU             7  N 47 08.1' E 007 56.5'                \n"
            "     7  LSZH              8  N 47 27.5' E 008 32.9'                \n"
            "     ----------------------------------------------                \n"
            "     0  EIDW              1  N 53 25.3' W 006 16.2'                \n"
            "     1  SUROX             2  N 53 59.8' W 006 59.6'                \n"
            "     2  N56W020           3  N 56 00.0' W 020 00.0'                \n"
            "     3  N56W030           4  N 56 00.0' W 030 00.0'                \n"
            "     4  N55W040           5  N 55 00.0' W 040 00.0'                \n"
            "     5  N53W050           6  N 53 00.0' W 050 00.0'                \n"
            "     6  YAY               7  N 51 23.6' W 056 05.0'                \n"
            "     7  YJT               8  N 48 35.0' W 058 40.2'                \n"
            "     8  YQY               9  N 46 09.2' W 060 03.3'                \n"
            "     9  SCUPP             1  N 42 36.2' W 070 13.8'                \n"
            "     1  KBOS              2  N 42 21.8' W 071 00.4'                \n"
            "                                                                   \n"
            " \"manual\" (output only):                                         \n"
            "      1  APT  LSGG               1  +46.238  +006.109              \n"
            "      2  fix  MOLUS              2  +46.444  +006.679              \n"
            "      3  fix  SOSAL              3  +46.558  +006.884              \n"
            "      4  fix  TELNO              4  +46.772  +007.271              \n"
            "      5  fix  KORED              5  +46.851  +007.414              \n"
            "      6  fix  KONOL              6  +46.995  +007.681              \n"
            "      7  fix  BERSU              7  +47.136  +007.941              \n"
            "      8  APT  LSZH               8  +47.458  +008.548              \n"
            "     ------------------------------------------------              \n"
            "      1  APT  EIDW               1  +53.421  -006.270              \n"
            "      2  fix  SUROX              2  +53.997  -006.993              \n"
            "      3  ---  N56W020            3  +56.000  -020.000              \n"
            "      4  ---  N56W030            4  +56.000  -030.000              \n"
            "      5  ---  N55W040            5  +55.000  -040.000              \n"
            "      6  ---  N53W050            6  +53.000  -050.000              \n"
            "      7  VOR  YAY                7  +51.394  -056.084              \n"
            "      8  VOR  YJT                8  +48.583  -058.669              \n"
            "      9  VOR  YQY                9  +46.153  -060.056              \n"
            "     10  fix  SCUPP             10  +42.603  -070.230              \n"
            "     11  APT  KBOS              11  +42.363  -071.006              \n"
            "                                                                   \n"
