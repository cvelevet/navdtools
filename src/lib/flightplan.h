...
typedef enum ndt_fltplanformat
{
    ...
    NDT_FLTPFMT_ICAOX, // ICAO route with departure/arrival airports, no SID/STAR (IXEG-optimized)
...
void*           ndt_flightplan_insert_direct(ndt_flightplan   *flightplan, ndt_waypoint *wpt, void *leg, int after_leg);
