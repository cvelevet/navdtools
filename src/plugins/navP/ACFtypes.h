...
typedef enum
{
        ...
        ACF_TYP_A321_TL = 0x0808000,
}
acf_type;
#define ACF_TYP_MASK_JDN (ACF_TYP_A320_JD|ACF_TYP_A330_JD)
#define ACF_TYP_MASK_QPC (ACF_TYP_A319_TL|ACF_TYP_A320_QP|ACF_TYP_A321_TL|ACF_TYP_A330_RW|ACF_TYP_A350_FF|ACF_TYP_A380_PH)
