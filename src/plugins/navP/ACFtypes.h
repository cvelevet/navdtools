...
typedef enum
{
    ...
    ACF_TYP_A350_FF = 0x0000008,
    ACF_TYP_B737_EA = 0x0000010,
    ACF_TYP_B737_XG = 0x0000020,
    ACF_TYP_B737_ZO = 0x0000040,
    ACF_TYP_B757_FF = 0x0000080,
    ACF_TYP_B767_FF = 0x0000100,
    ACF_TYP_B777_FF = 0x0000200,
    ACF_TYP_CL30_DD = 0x0000400,
    ACF_TYP_EMBE_SS = 0x0000800,
    ACF_TYP_EMBE_XC = 0x0001000,
    ACF_TYP_HA4T_RW = 0x0002000,
    ACF_TYP_LEGA_XC = 0x0004000,
    ACF_TYP_MD80_RO = 0x0008000,
    ACF_TYP_PHOLDR1 = 0x0010000,
